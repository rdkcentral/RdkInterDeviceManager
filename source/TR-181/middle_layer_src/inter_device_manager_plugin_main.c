...
#include "inter_device_manager_plugin_main.h"
...
int ANSC_EXPORT_API InterDeviceManager_DMLInit
    (
    ...
    )
{
    ...
    pPlugInfo->RegisterFunction(pPlugInfo->hContext, "IDM_Conn_GetParamStringValue", IDM_Conn_GetParamStringValue);
    pPlugInfo->RegisterFunction(pPlugInfo->hContext, "IDM_Conn_SetParamStringValue", IDM_Conn_SetParamStringValue);
    pPlugInfo->RegisterFunction(pPlugInfo->hContext, "IDM_Conn_GetParamUlongValue", IDM_Conn_GetParamUlongValue);
    pPlugInfo->RegisterFunction(pPlugInfo->hContext, "IDM_Conn_SetParamUlongValue", IDM_Conn_SetParamUlongValue);
    pPlugInfo->RegisterFunction(pPlugInfo->hContext, "IDM_Remote_SetParamStringValue", IDM_Remote_SetParamStringValue);
    pPlugInfo->RegisterFunction(pPlugInfo->hContext, "IDM_RemoteList_GetEntryCount", IDM_RemoteList_GetEntryCount);
    pPlugInfo->RegisterFunction(pPlugInfo->hContext, "IDM_RemoteList_GetEntry", IDM_RemoteList_GetEntry);
    pPlugInfo->RegisterFunction(pPlugInfo->hContext, "IDM_RemoteList_GetParamUlongValue", IDM_RemoteList_GetParamUlongValue);
    pPlugInfo->RegisterFunction(pPlugInfo->hContext, "IDM_RemoteList_GetParamStringValue", IDM_RemoteList_GetParamStringValue);
